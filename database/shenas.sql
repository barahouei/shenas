...
// <![CDATA[
CommonParams.setAll({common_query:"lang=en",opendb_url:"index.php?route=/database/structure&lang=en",lang:"en",server:"1",table:"",db:"",token:"25423b6f264f50564a4b5a605e284221",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:false,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.0",auth_type:"cookie",user:"root"});
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="get" action="index.php?route=/&lang=en" class="disableAjax">
          <input type="hidden" name="route" value="/export"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="25423b6f264f50564a4b5a605e284221">
...
<form method="post" id="login_form" action="index.php?route=/" name="login_form" class="disableAjax hide js-show" autocomplete="off">
    <input type="hidden" name="route" value="/export"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="25423b6f264f50564a4b5a605e284221">
  <input type="hidden" name="set_session" value="qmiaceg30k8kmrggbq07bv95dc">
